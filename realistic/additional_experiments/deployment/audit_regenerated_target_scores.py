...
out=[];checks=Counter()
for model,version,hub in [('Gemma4-E4B','v1','models--google--gemma-4-E4B-it')]:
 root=b/'aligned_gemma_kth_sdpa_20260907_v1'
...
(b/'regenerated_target_score_audit.json').write_text(json.dumps(result))
