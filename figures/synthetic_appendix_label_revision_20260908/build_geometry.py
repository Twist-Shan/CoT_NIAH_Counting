...
def save_relabelled(fig, _stem, _title):
    ...
    replacements = {
        ...
        'C. Non-thinking: final count': 'C. Non-thinking: final count (L2)',
    ...
    metadata = {
        ...
        'same_evaluation_states': True, 'other_three_projections_unchanged': True,
...
def geometry():
    """Use archived L4 PCA coordinates for thinking running-index states only."""
...
def main():
    ...
    geometry()
    print('Installed PCA: thinking running index at L4; the other panels at L2.')
